...
images: ['/static/images/blog/2023/ai_generated_hero_images/hero_image.png']
authors: ['sellmann']
---
...
![Tech-inspired seascape with a central dugong in deep
teal.](/static/images/blog/2023/ai_generated_hero_images/image1.png)
...
![Tech-ocean blend with dugong in bright deep teal, 8k
resolution.](/static/images/blog/2023/ai_generated_hero_images/image2.png)
...
![Woman on a beach in chrome reflections and flat art
style.](/static/images/blog/2023/ai_generated_hero_images/image3.png)
...
![8k cartoon programmer with laptop and dugong, blue sky
backdrop](/static/images/blog/2023/ai_generated_hero_images/image4.png)
...
![Generated design from Midjourney](/static/images/blog/2023/ai_generated_hero_images/image16.png)


![8k illustration: figure with laptop against ocean and
sky.](/static/images/blog/2023/ai_generated_hero_images/image5.png)
...
![Girl with computer against dark San Francisco, candid
style.](/static/images/blog/2023/ai_generated_hero_images/image6.png)
...
![Elegant Japanese IT engineer programming on a laptop with another screen
showing code, lit softly.](/static/images/blog/2023/ai_generated_hero_images/image7.png)
...
![Beautiful Japanese IT engineer coding on a laptop, soft ambient
lighting.](/static/images/blog/2023/ai_generated_hero_images/image8.png)
>プロンプト:A beautiful Japanese female IT engineer, as stunning as a celebrity, programming an application on a laptop. Another screen is displaying lines of programming code. Lighting: The scene is illuminated by a soft, ambient light that evenly spreads across the engineer's face and the surrounding workspace. --ar 16:9 --niji 5

![Japanese female IT engineer programming, second screen with code, softly
illuminated.](/static/images/blog/2023/ai_generated_hero_images/image9.png)
>プロンプト:A beautiful Japanese female IT engineer, as stunning as a celebrity, programming an application on a laptop. Another screen is displaying lines of programming code. Lighting: The scene is illuminated by a soft, ambient light that evenly spreads across the engineer's face and the surrounding workspace. --ar 16:9 --niji 5

![Businessman's hand touching global network connections against sunset,
abstract tech imagery.](/static/images/blog/2023/ai_generated_hero_images/image10.png)
...
![Generated design from Seed.](/static/images/blog/2023/ai_generated_hero_images/image17.png)

![Japanese IT engineer with laptop, code on background screen, softly lit.
](/static/images/blog/2023/ai_generated_hero_images/image11.png)
...
![Smiling Japanese IT engineer holding laptop, soft ambient lit scene with
background code.](/static/images/blog/2023/ai_generated_hero_images/image12.png)
...
![Joyful Japanese IT engineer celebrating project completion, soft light with
background code](/static/images/blog/2023/ai_generated_hero_images/image13.png)
...
![High-resolution image of a generated
design](/static/images/blog/2023/ai_generated_hero_images/image15.png)
